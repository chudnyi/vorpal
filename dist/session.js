...
class Session extends events_1.EventEmitter {
    ...
    constructor(options) {
        ...
        this._delimiter = options.delimiter || String(os_1.default.hostname()).split('.')[0] + '~$';
     ...
     * @api private
     */
    getKeypressResult(key, value, cb = lodash_1.default.noop) {
    ...
    getAutocomplete(str, cb) {
        return autocomplete_1.default.exec.call(this, str, cb);
    }
    _autocomplete(str, arr) {
        return autocomplete_1.default.match.call(this, str, arr);
    }
    /**
    ...
    execCommandSet(wrapper, callback) {
        ...
        const commandInstance = new command_instance_1.CommandInstance({
        ...
        this.cancelCommands = function () {
            const callCancel = function (commandInstanceInner) {
                if (lodash_1.default.isFunction(commandInstanceInner.commandObject._cancel)) {
            ...
            if (res && lodash_1.default.isFunction(res.cancel)) {
        ...
        let valid;
        if (lodash_1.default.isFunction(wrapper.validate)) {
            try {
