...
class UI extends events_1.EventEmitter {
    ...
    constructor() {
        ...
        this._log = process.env.NODE_ENV === 'test' ? lodash_1.default.noop : console.log.bind(console);
        ...
        for (const promptType of prompts) {
            ...
            inquirer_1.default.prompt.prompts[promptType].prototype.getType = function () {
                return promptType;
            };
            // Hook in to steal Inquirer's keypress.
            inquirer_1.default.prompt.prompts[promptType].prototype.onKeypress = function (e) {
            ...
            const render = inquirer_1.default.prompt.prompts[promptType].prototype.render;
            inquirer_1.default.prompt.prompts[promptType].prototype.render = function (...args) {
                self._activePrompt = this;
        ...
        const onSigInt = () => {
            if (lodash_1.default.isFunction(this._sigint) && !this._sigintCalled) {
                this._sigintCalled = true;
    ...
    prompt(options, cb) {
        ...
        try {
            prompt = inquirer_1.default.prompt(options).then(result => {
                this.inquirerStdout = [];
                this._midPrompt = false;
    ...
    setDelimiter(str) {
        ...
        inquirer_1.default.prompt.prompts.password.prototype.getQuestion = function () {
            self._activePrompt = this;
            return this.opt.message;
        };
        inquirer_1.default.prompt.prompts.input.prototype.getQuestion = function () {
            self._activePrompt = this;
    ...
    _keypressHandler(e, prompt) {
        ...
        // Mask passwords.
        const line = prompt.getType() !== 'password' ? prompt.rl.line : '*'.repeat(prompt.rl.line.length);
        ...
        const addition = prompt.status === 'answered' ? chalk_1.default.cyan(prompt.answer) : line;
        message += addition;
     ...
     */
    log(...args) {
        args = lodash_1.default.isFunction(this._pipeFn) ? this._pipeFn(args) : args;
        ...
        if (this.midPrompt()) {
            ...
            this._log(...args);
            if (!lodash_1.default.isUndefined(data) && data !== false) {
                this.resume(data);
            }
            else {
    ...
    input(str) {
        ...
        prompt.rl.cursor += diff;
        let message = prompt.getQuestion();
        const addition = prompt.status === 'answered' ? chalk_1.default.cyan(prompt.answer) : prompt.rl.line;
        message += addition;
        prompt.screen.render(message);
        return this;
    }
...
exports.default = global.__vorpal.ui.exports;
